...
export const XING = [
  ...
  "龙", "叶", "幸", "司", "韶", "郜", "黎", "蓟", "薄", "印", "宿", "白", "怀", "蒲", "台",
  "从", "鄂", "索", "咸", "籍", "赖", "卓", "蔺", "屠", "蒙", "池", "乔", "阴", "郁", "胥",
  "能", "苍", "双", "闻", "莘", "党", "翟", "谭", "贡", "劳", "逄", "姬", "申", "扶", "堵",
  "冉", "宰", "郦", "雍", "郤", "璩", "桑", "桂", "濮", "牛", "寿", "通", "边", "扈", "燕",
  "冀", "浦", "尚", "农", "温", "别", "庄", "晏", "柴", "瞿", "阎", "慕", "连", "茹", "习",
  "宦", "艾", "鱼", "容", "向", "古", "易", "慎", "戈", "廖", "庾", "终", "暨", "居", "衡",
  "步", "都", "耿", "满", "弘", "匡", "国", "文", "寇", "广", "禄", "阙", "东", "殴", "殳",
  "沃", "利", "蔚", "越", "夔", "隆", "师", "巩", "厍", "聂", "晁", "勾", "敖", "融", "冷",
  "訾", "辛", "阚", "那", "简", "饶", "空", "曾", "毋", "沙", "乜", "养", "鞠", "须", "丰",
  "巢", "关", "蒯", "相", "查", "后", "荆", "红", "游", "竺", "权", "逯", "盖", "益", "桓",
  "公", "仉", "督", "晋", "楚", "阎", "法", "汝", "鄢", "涂", "钦", "岳", "帅", "缑", "亢",
  "况", "郈", "有", "琴", "归", "海", "勾", "公冶", "亓官", "欧阳", "南宫", "司马", "上官",
  "夏侯", "诸葛", "百里", "东郭", "呼延", "尉迟", "端木", "羊舌", "微生", "左丘", "万俟",
  "司空", "第五", "赫连", "皇甫", "尹文", "段干", "东里", "公孙", "仲孙", "轩辕", "令狐",
  "慕容", "闾丘", "令狐", "濮阳", "淳于", "西门", "夏侯", "闻人", "轩辕", "钟离", "宇文",
  "长孙", "司徒", "公羊", "公冶", "公良", "谷梁", "皇甫", "南门", "独孤", "东方", "子车",
  "公西", "仲长", "太史", "欧阳", "太叔", "申屠", "公山", "公冶", "第五", "夷侯", "万俟",
]
